...
- Buttons: 14px (header, letter-spacing 0.3px; hero) and 16px (book-a-meeting,
  letter-spacing 2px).
...
`24px` (header pill), `20px` (hero CTA), `10px` (book-a-meeting CTA),
...
- **PillButton** — white rounded button, `font-body` 600, hover background
  `pill-hover`. Variants by radius: `pill` (24px, header), `md` (20px, hero),
  `sm` (10px, book-a-meeting).
  Renders an `<a>`;
