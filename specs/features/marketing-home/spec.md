...
The booking dialog MUST embed the Calendly inline scheduling widget,
loaded from Calendly's hosted script,
...
- **THEN** the Calendly inline widget loads inside the dialog
