...
<div class="feature__wrapper">
  <div class="content-container">
    ...
    <div class="">
        <img class="img-pr" loading="lazy" width="640" height="360" src="assets/images/grid.webp" alt="Elemwave workbench grid definition"/>
        <br>
        <div class="img-cap"> View of a grid definition for an FDTD problem.</div>
        <br>
        <img class="img-pr" loading="lazy" width="640" height="360" src="assets/images/farfield.webp" alt="Elemwave workbench far field definition"/>
        <br>
